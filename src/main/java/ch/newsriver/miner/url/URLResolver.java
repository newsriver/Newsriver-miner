package ch.newsriver.miner.url;
...
*/
    ...
    public URI escapeURI(String dirtyUrl) {
        try {
            ...
            URL uri = new URL(java.net.URLDecoder.decode(dirtyUrl.trim(),"utf-8")); //decode in case there are urlencoded chars
            ...
            try {
                ...
                if (ex.getCause().getClass().isAssignableFrom(ProtocolException.class)) {
                    if (ex.getCause().getCause().getClass().isAssignableFrom(URISyntaxException.class)) {
                        ...
                        URL uri = new URL(java.net.URLDecoder.decode(e.getInput(),"utf-8"));
